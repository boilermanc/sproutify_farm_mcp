export class ReportGenerator {
    ...
    generateHTMLTemplate(title, content, context) {
...
<body>
  ...
  <div class="page-container">
    ...
    // Tower Status Report
    async generateTowerStatusReport(context) {
    ...
    async generateSeedInventoryReport(context) {
    ...
    async generateWeeklyPlanningReport(context) {
    ...
    // Harvest Report
    async generateHarvestReport(context) {
    ...
    async generateProductionSummaryReport(context) {
