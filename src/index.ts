  ...
  try {
    switch (name) {
      case "get_towers": {
        ...
        const farmId = (args as any).farmId as string;
      ...
      case "get_spray_logs": {
        ...
        const farmId = (args as any).farmId as string;
        const sprayType = (args as any).sprayType as string | undefined;
        const limit = (args as any).limit as number | undefined;
      ...
      case "get_seed_inventory": {
        ...
        const farmId = (args as any).farmId as string;
        const lowStock = (args as any).lowStock as boolean | undefined;
        const cropId = (args as any).cropId as string | undefined;
